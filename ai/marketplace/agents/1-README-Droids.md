...
|------------|-------------|------------------|-------|
| **orchestrator** | Master coordinator for project analysis, planning, and execution | Project analysis, research, memory integration, strategic planning, direct implementation, quality assurance | claude-sonnet-4-5-20250929 |
| **tdd-orchestrator** | Test-driven development orchestration specialist | TDD workflow coordination, test planning, implementation guidance | claude-sonnet-4-5-20250929 |

### 🤖 AI & Machine Learning

| Droid Name | Description | Key Capabilities | Model |
|------------|-------------|------------------|-------|
| **ai-engineer** | Build LLM applications, RAG systems, and prompt pipelines | LLM integration, RAG systems, vector databases, prompt engineering, agent frameworks, token optimization | claude-opus-4-1-20250805 |
| **ml-engineer** | Machine learning model development and deployment | ML model development, training pipelines, deployment, monitoring | claude-sonnet-4-5-20250929 |
| **mlops-engineer** | MLOps infrastructure and pipeline engineering | ML pipelines, model versioning, deployment automation, monitoring | claude-sonnet-4-5-20250929 |
| **prompt-engineer** | Advanced prompt engineering and optimization | Prompt design, optimization, A/B testing, structured outputs | claude-sonnet-4-5-20250929 |

### ⚙️ Backend Development

| Droid Name | Description | Key Capabilities | Model |
|------------|-------------|------------------|-------|
| **backend-architect** | Backend system architecture and design | System architecture, API design, microservices, scalability patterns | claude-sonnet-4-5-20250929 |
| **backend-typescript-architect** | TypeScript backend architecture | TypeScript Node.js development, type-safe APIs, enterprise patterns | claude-sonnet-4-5-20250929 |
| **fastapi-pro** | FastAPI framework specialist | FastAPI development, async programming, API documentation, testing | claude-sonnet-4-5-20250929 |
| **django-pro** | Django framework expert | Django development, ORM optimization, admin interfaces, security | claude-sonnet-4-5-20250929 |
| **golang-expert** | Go backend development | Go development, concurrent programming, microservices, performance | claude-sonnet-4-5-20250929 |
| **golang-pro** | Advanced Go programming | Advanced Go patterns, performance optimization, system programming | claude-sonnet-4-5-20250929 |
| **rust-expert** | Rust backend development | Rust development, memory safety, performance, async programming | claude-sonnet-4-5-20250929 |
| **rust-pro** | Advanced Rust programming | Advanced Rust patterns, unsafe code, optimization, FFI | claude-sonnet-4-5-20250929 |
| **elixir-pro** | Elixir/Phoenix backend development | Elixir/Phoenix development, concurrent systems, real-time applications | claude-sonnet-4-5-20250929 |
| **php-expert** | PHP backend development | PHP development, Laravel/Symfony, API development | claude-sonnet-4-5-20250929 |
| **php-pro** | Advanced PHP programming | Advanced PHP patterns, performance optimization, enterprise development | claude-sonnet-4-5-20250929 |
| **ruby-expert** | Ruby/Rails backend development | Ruby/Rails development, API design, testing, deployment | claude-sonnet-4-5-20250929 |
| **ruby-pro** | Advanced Ruby programming | Advanced Ruby patterns, metaprogramming, performance optimization | claude-sonnet-4-5-20250929 |
| **scala-pro** | Scala backend development | Scala development, functional programming, Akka, big data | claude-sonnet-4-5-20250929 |
| **cpp-engineer** | C++ backend development | C++ development, modern C++, performance, system programming | claude-sonnet-4-5-20250929 |
| **cpp-pro** | Advanced C++ programming | Advanced C++ patterns, template metaprogramming, optimization | claude-sonnet-4-5-20250929 |
...
| Droid Name | Description | Key Capabilities | Model |
|------------|-------------|------------------|-------|
| **architect-review** | Architecture review and assessment | Architecture analysis, pattern review, design evaluation | claude-sonnet-4-5-20250929 |
| **docs-architect** | Documentation architecture | Documentation structure, information architecture | claude-sonnet-4-5-20250929 |
| **graphql-architect** | GraphQL API design | GraphQL schema design, API architecture, resolver patterns | claude-sonnet-4-5-20250929 |
| **ui-ux-designer** | UI/UX design and implementation | Design systems, user experience, interface design | claude-sonnet-4-5-20250929 |

### 💼 Business & Strategy

| Droid Name | Description | Key Capabilities | Model |
|------------|-------------|------------------|-------|
| **business-analyst** | Business analysis and requirements | Requirements gathering, business process analysis, stakeholder management | claude-sonnet-4-5-20250929 |
| **hr-pro** | HR processes and automation | HR workflows, process automation, employee management | claude-sonnet-4-5-20250929 |
| **legal-advisor** | Legal compliance and advisory | Legal requirements, compliance, intellectual property | claude-sonnet-4-5-20250929 |
| **risk-manager** | Risk assessment and management | Risk analysis, mitigation strategies, compliance | claude-sonnet-4-5-20250929 |
| **sales-automator** | Sales process automation | Sales workflows, CRM integration, automation | claude-sonnet-4-5-20250929 |

### 🔧 Specialized Domains

| Droid Name | Description | Key Capabilities | Model |
|------------|-------------|------------------|-------|
| **arm-cortex-expert** | ARM Cortex microcontroller development | Embedded systems, ARM architecture, IoT development | claude-sonnet-4-5-20250929 |
| **blockchain-developer** | Blockchain and cryptocurrency development | Smart contracts, DApps, blockchain architecture | claude-sonnet-4-5-20250929 |
| **wordpress-developer** | WordPress development and customization | WordPress themes, plugins, customization | claude-sonnet-4-5-20250929 |
| **minecraft-bukkit-pro** | Minecraft Bukkit plugin development | Minecraft plugins, Bukkit API, game modifications | claude-sonnet-4-5-20250929 |
| **payment-integration** | Payment system integration | Payment gateways, Stripe/PayPal integration, compliance | claude-sonnet-4-5-20250929 |
| **legacy-modernizer** | Legacy system modernization | System migration, modernization strategies, refactoring | claude-sonnet-4-5-20250929 |
| **reference-builder** | Reference implementation builder | Reference architectures, example implementations | claude-sonnet-4-5-20250929 |

### 🔍 SEO & Digital Marketing

| Droid Name | Description | Key Capabilities | Model |
|------------|-------------|------------------|-------|
| **seo-authority-builder** | SEO authority and link building | Link building strategies, domain authority, off-page SEO | claude-sonnet-4-5-20250929 |
| **seo-cannibalization-detector** | SEO content cannibalization detection | Content analysis, keyword overlap, cannibalization fixes | claude-sonnet-4-5-20250929 |
| **seo-content-auditor** | SEO content auditing | Content analysis, SEO audit, optimization recommendations | claude-sonnet-4-5-20250929 |
| **seo-content-planner** | SEO content strategy planning | Content strategy, keyword research, editorial planning | claude-sonnet-4-5-20250929 |
| **seo-content-refresher** | SEO content updating | Content refresh, updating outdated content, SEO improvements | claude-sonnet-4-5-20250929 |
| **seo-content-writer** | SEO-optimized content creation | SEO writing, keyword optimization, content creation | claude-sonnet-4-5-20250929 |
| **seo-keyword-strategist** | SEO keyword research and strategy | Keyword research, competitive analysis, keyword strategy | claude-sonnet-4-5-20250929 |
| **seo-meta-optimizer** | SEO meta tag optimization | Meta tags, schema markup, snippet optimization | claude-sonnet-4-5-20250929 |
| **seo-snippet-hunter** | Featured snippet optimization | Featured snippets, rich snippets, SERP optimization | claude-sonnet-4-5-20250929 |
| **seo-structure-architect** | SEO site structure optimization | Site architecture, URL structure, internal linking | claude-sonnet-4-5-20250929 |
