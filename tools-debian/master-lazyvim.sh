...
main() {
    ...
    if command_exists nvim; then
        ...
        log "ERROR" "  - sudo apt install neovim"
    ...
    # Install lua5.1
    install_package "lua5.1" "sudo apt install -y lua5.1" "lua5.1 -v" "Lua 5.1"

    # Install luarocks
    install_package "luarocks" "sudo apt install -y luarocks" "luarocks --version" "LuaRocks"
    ...
    if ! command_exists npm; then
        ...
        log "ERROR" "sudo apt-get install -y nodejs"
        exit 1
    fi
    ...
    install_package "texlive-latex-base" "sudo apt install -y texlive-latex-base" "dpkg -l | grep texlive-latex-base" "TeX Live Base"
    install_package "texlive-latex-extra" "sudo apt install -y texlive-latex-extra" "dpkg -l | grep texlive-latex-extra" "TeX Live Extra"
    ...
    if ! command_exists git; then
        log "ERROR" "git is not installed. Please install git first: sudo apt install git"
        exit 1
    fi
