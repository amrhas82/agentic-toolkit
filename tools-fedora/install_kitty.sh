...
# =============================================================================
# Kitty Terminal Installation and Configuration Script (Fedora)
# =============================================================================
# This script will:
...
# Main installation
print_header "Kitty Terminal Installation Script (Fedora)"
...
if ! command -v dnf &> /dev/null; then
    ...
    print_info "This script is designed for Fedora systems"
    exit 1
fi
print_success "Package manager found (dnf)"
...
if [[ $REPLY =~ ^[Yy]$ ]]; then
    ...
    # Check if update-alternatives is available (Fedora has it)
