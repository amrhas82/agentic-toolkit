# Generated by Powerlevel10k configuration wizard on 2026-01-25 at 17:31 CET.
# Based on romkatv/powerlevel10k/config/p10k-classic.zsh, checksum 13396.
# Wizard options: powerline, classic, ascii, darkest, 2 lines, disconnected, compact,
...
# Replace tilde with footprints emoji in prompt
function prompt_my_dir() {
  local dir="${(%):-%~}"
  dir="${dir/#\~/$'👣'}"
  p10k segment -f 31 -t "$dir"
}
